...
(function () {
  ...
  var RU = {
    ...
    // --- Home ---
    "page.index.title": "Callifornia, простые видеозвонки для Windows и Linux",
    "page.index.desc":
    ...
    "mobile.text":
      "Callifornia пока работает на компьютерах с Windows и Linux. Откройте эту страницу на компьютере, чтобы скачать.",
    ...
    "f1.title": "Вход по ссылке или короткому коду",
    "f1.text":
      "У каждого звонка есть ссылка, а в ней короткий код. Отправьте в любом чате хоть ссылку, хоть код, и человек с приложением окажется в звонке через пару секунд. Ничего не протухает, и никто не ждёт под дверью, пока его впустят.",
    ...
    "mock.join.hint": "Вставьте ссылку на звонок или введите её код.",

    "f2.title": "Видно, кто рядом, ещё до звонка",
    "f2.text":
      "Добавьте человека один раз и звоните когда угодно, не разыскивая нужную ссылку по чатам. Статусы живые, поэтому сразу видно, кто свободен, кто уже в звонке, а кто сидит в общем пространстве и ждёт вас.",
    ...
    "f3.title": "Обновления, которые не мешают",
    "f3.text":
    ...
    "also.chat.text":
      "Для ссылки или имени, которое неохота диктовать вслух. Чат хранится вместе со звонком, поэтому он на месте и в следующий раз.",
    "also.spaces.title": "Пространства на своём месте",
    "also.spaces.text":
      "Отдельная комната для команды или компании друзей, всегда там же, где вы её оставили.",
    "also.invites.title": "Приглашения вместо ссылок",
    "also.invites.text":
      "Позовите друга в звонок, в котором уже сидите. Ему постучится приложение, и один клик приведёт его к вам.",
    "also.theme.title": "Светлая и тёмная",
    "also.theme.text":
      "Следует за темой системы или остаётся на той, которая нравится вам.",
    ...
    "cta.sub": "Скачайте Callifornia и окажитесь в первом звонке меньше чем за минуту.",
    ...
    // --- Privacy ---
    "page.privacy.title": "Конфиденциальность, Callifornia",
    "page.privacy.desc": "Какие данные собирает Callifornia, каких не собирает и почему.",
    "privacy.title": "Конфиденциальность",
    "privacy.sub":
      "Обновлено 13 августа 2026 года. Если коротко, Callifornia собирает то, без чего не соединить ваши звонки и не доставить сообщения, и почти ничего больше.",
    "privacy.collect.h": "Что мы собираем",
    "privacy.collect.1":
      "<strong>Данные аккаунта</strong>, то есть имя пользователя, отображаемое имя и пароль, с которыми вы зарегистрировались. Именно они позволяют друзьям найти вас и позвонить.",
    "privacy.collect.email":
      "<strong>Адрес электронной почты.</strong> У него одна задача — вернуть вам доступ, если вы забыли пароль, и подтвердить, что адрес действительно ваш. Рассылок мы не делаем, подписываться не на что.",
    "privacy.collect.messages":
      "<strong>Ваши сообщения.</strong> Переписка в спейсе хранится на наших серверах, чтобы она была на месте, когда вы вернётесь, и живёт до удаления самого спейса. Переписка в разовом звонке уходит вместе со звонком.",
    "privacy.collect.pictures":
      "<strong>Фотографии профиля и спейсов</strong>, если вы их поставили. Сейчас они отдаются по публичному адресу: любой, у кого есть ссылка, откроет изображение без входа в аккаунт.",
    "privacy.collect.social":
      "<strong>С кем вы связаны</strong> — друзья, спейсы и их участники, а также то, в сети вы или в звонке. Чтобы доставить звонок или сообщение, нужно знать, куда его отправлять.",
    "privacy.collect.2":
      "<strong>Данные соединения</strong>, то есть техническая сигнализация, без которой не установить звонок между участниками (кто в какой звонок входит и что нужно сети, чтобы вас соединить), а также IP-адрес, с которого подключается ваше устройство.",
    "privacy.collect.3":
    ...
    "privacy.never.1":
      "<strong>Звонки не записываются.</strong> Звук, видео и показ экрана шифруются и по дороге к нашему серверу, и по дороге от него, и никуда не записываются.",
    "privacy.never.2":
    ...
    "privacy.never.3":
      "<strong>Никакого сбора контактов.</strong> Callifornia не читает вашу адресную книгу, файлы и вообще ничего на вашей машине, кроме собственных настроек.",
    "privacy.e2e.h": "Что здесь значит «шифруется», а что не значит",
    "privacy.e2e.p":
      "Callifornia не использует сквозное шифрование, и мы предпочитаем сказать об этом прямо, а не позволять слову «шифруется» значить больше, чем оно заслужило. Трафик между приложением и нашими серверами зашифрован, медиа звонка — тоже на обоих участках, но звонок проходит через наш сервер, который его маршрутизирует, а сообщения лежат в нашей базе в читаемом для нас виде. На практике это значит, что администратор с доступом к серверам может прочитать сохранённую переписку — и то же самое сможет тот, кто получит такой доступ без спроса. Если для того, что вы собираетесь сказать, это важно, скажите это в другом месте.",
    "privacy.processors.h": "Кто ещё имеет отношение к этим данным",
    "privacy.processors.p":
      "Callifornia работает на Yandex Cloud: там серверы, база данных и файловое хранилище. Письма подтверждения и восстановления пароля уходят через Yandex Cloud Postbox. Других сторонних сервисов нет, аналитики и рекламы — тоже никакой.",
    ...
    "privacy.retention.p":
      "Данные аккаунта хранятся, пока существует аккаунт. Сообщения в спейсе живут до удаления самого спейса; разовая комната звонка и всё сказанное в ней удаляются через 30 дней без использования. Аккаунт, так и не подтвердивший адрес почты, удаляется через неделю вместе с занятым им именем пользователя. Захотите удалить аккаунт вместе с данными, напишите нам по адресу ниже, и мы всё уберём.",
    ...
    "join.invalid.sub":
      "В ней нет кода звонка. Попросите новую ссылку у того, кто её прислал, или откройте Callifornia и введите код вручную.",
