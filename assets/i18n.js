...
(function () {
  ...
  var RU = {
    ...
    "changelog.sub":
      "Каждый выпуск по порядку. Приложение ставит эти обновления само, а страница нужна, чтобы видеть, что и когда изменилось.",
    ...
    "cl.0014.title": "Показ экрана на Wayland больше не гаснет",
    "cl.0014.li1":
      "Показ доходил до передачи и умирал за миллисекунды, потому что запуск захвата сносил ровно ту сессию, из которой собирался читать. Больше не сносит.",
    "cl.0013.date": "7 августа 2026",
    "cl.0013.title": "Показ экрана на Wayland доехал",
    "cl.0013.li1":
      "Везёт исправление из 0.0.12, которое так и не вышло, потому что GitHub Actions лежал в крупном сбое",
    "cl.0013.li2":
    ...
    "cl.0012.date": "6 августа 2026",
    "cl.0012.title": "Правильный порядок для Wayland",
    "cl.0012.li1":
      "Показ падал с ошибкой «no target node available», потому что цикл PipeWire запускался после того, как поток уже искал свой узел. Теперь цикл стартует первым.",
    "cl.0012.note":
      "Эта версия так и не вышла. GitHub Actions лежал, пока её собирали, поэтому исправление приехало в 0.0.13.",
    "cl.0011.date": "6 августа 2026",
    "cl.0011.title": "Сессия портала живёт дольше рукопожатия",
    "cl.0011.li1":
      "Показ умирал в тот же миг, когда его разрешали, потому что соединение, открывшее сессию, закрывалось сразу после рукопожатия. Теперь оно живёт столько же, сколько показ.",
    "cl.0011.li2":
      "Окно выбора спрашивают каждый раз, а не запоминают источник, поэтому второй показ не покажет молча то же самое окно",
    "cl.0010.date": "6 августа 2026",
    "cl.0010.title": "Поиск узла, который выдал портал",
    "cl.0010.li1":
      "Показ на Wayland спрашивал разрешение, получал его и не показывал ничего. Теперь узел называется так, как его читает нынешний PipeWire.",
    "cl.0010.li2":
      "О кадрах, которые приложение не может прочитать, сообщают один раз, а не выбрасывают их молча",
    "cl.009.date": "6 августа 2026",
    "cl.009.title": "Показ экрана на Wayland",
    "cl.009.li1":
      "Показ на Wayland идёт через окно выбора вашего рабочего стола и PipeWire, а не притворяется работающим, пока остальные видят чёрный прямоугольник",
    "cl.009.li2":
      "Сеанс, который вообще нельзя захватить, теперь отказывает с сообщением, ещё до того как хоть один кадр уйдёт в звонок",
    "cl.009.li3":
      "Обновления пакетов на Linux показывают настоящий вывод пакетного менеджера",
    ...
    "cl.006.date": "5 августа 2026",
    "cl.006.title": "Пересборка 0.0.5",
    "cl.006.li1":
      "То же приложение, что и 0.0.5. Его сборка для Linux упала на подписи репозитория уже после того, как манифест обновления ушёл.",
